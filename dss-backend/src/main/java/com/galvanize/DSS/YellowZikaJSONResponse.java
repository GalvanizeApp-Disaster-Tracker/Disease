...
public class YellowZikaJSONResponse {
    ...
    private GeoCoded geocoded_column;
    ...
    public GeoCoded getGeocoded_column() {
        return geocoded_column;
    }

    public void setGeocoded_column(GeoCoded geocoded_column) {
